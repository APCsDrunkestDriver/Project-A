...
class pong(arcade.Window):
    def random_vilocity():
        ...
        # this stops the ball from bouncing up and down almost virtically at the start of the game.
        loop = True
        while loop == True:
    ...
    def __init__(self):
        ...
        # define the base direcory for the bounce sound using the pathlib library
        ...
        self.left_paddle = left_paddle.left_paddle(50, 240, 7, 70, arcade.color.WHITE, move_speed=10)
        
        #define the right paddle
        self.right_paddle = right_paddle.right_paddle(590, 240, 7, 70, arcade.color.WHITE, move_speed=10)

        #calls the random vilocity function
        numx, numy = pong.random_vilocity()

        #define the ball
        self.ball = ball.ball(300,200,10,10,arcade.color.WHITE, vilocity=(numx, numy))
